...
export const base = {
  ...
  blockToolbarIconSelected: colors.textHighlight,
  blockToolbarText: colors.almostBlack,
  blockToolbarTextSelected: colors.textHighlight,
...
export const light = {
  ...
  toolbarBackground: colors.codeEntity,
  toolbarHoverBackground: colors.codeEntity,
  toolbarInput: colors.codeEntity,
  toolbarItem: colors.codeEntity,
